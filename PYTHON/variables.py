...
print type(a)
print "Mainīgā a vērtība ir kā dec skaitlis ir %d"%(a)
print "Mainīgā a vērtība ir kā hex skaitlis ir %x"%(a)
print "Mainīgā a vērtība ir kā oct skaitlis ir %o"%(a)
print "Mainīgā a vērtība ir kā simbols ir %c"%(a)
